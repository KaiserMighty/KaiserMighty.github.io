...
const items = [
  {
    id: 1,
    title: 'Hermes Navigator for Linux',
    route: '/'
  },
  {
    id: 2,
    title: 'NERSC Perlmutter Projects',
    route: '/'
  },
  {
    id: 3,
    title: '32-Bit CPU and Assembler',
    route: '/'
  },
  {
    id: 4,
    title: 'Extents Based File-System',
    route: '/'
  },
  {
    id: 5,
    title: 'SFPD CSV Data Processor',
    route: '/'
  },
];
  ...
  return (
    <div className="bg-[var(--lowlevel-bg)] text-[var(--lowlevel-text)] font-mono h-screen p-6">
      <div className="relative flex items-center mb-4">
        <button onClick={() => navigate("/")} className="absolute left-0 text-lg">Back</button>
